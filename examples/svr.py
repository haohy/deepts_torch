...
def TSF_SVR(config_model, config_dataset, model_name, ds_name):
    ...
    dynamic_feature_cat = dynamic_feature_cat[:, -n_fore:, :]
    time_series = time_series[:, -n_fore:]
    dim_feat = dynamic_feature_cat.shape[-1]
    x_train, x_test = train_test_split(dynamic_feature_cat, test_size=0.2)
